# Primeira semana - Ciclo 1 (Projeto Makers)
Aluno: Marcelo Vitor Machado da Silva Filho <br>
Matrícula: 252004147

# Atividade da semana
Foi solicitado um estudo mais aprofundado sobre Git e GitHub, trazendo um aprofundamento usando os seguintes materiais:<br>
**Simulador**: Learn Git Branching <br>
**Trilhas do GitHub Skills** (enfoque maior nas "Introduction to GitHub" e "Communicate using Markdown") <br>
**Livro didático**: Pro Git
